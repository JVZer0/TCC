...
namespace Backend.Business
{
    public class AnuncioBusiness
    {
        ...
        public Models.TbAnuncio AlterarAnuncio(Models.TbAnuncio NovoAnuncio)
        {
            ...
            if(NovoAnuncio.NmMarca == "undefined" || NovoAnuncio.NmMarca ==  "") NovoAnuncio.NmMarca = "Sem marca";
            if(NovoAnuncio.DsDescricao == "undefined" || NovoAnuncio.DsDescricao == "") NovoAnuncio.DsDescricao = "";
            try
            {
